...
argparse.add_argument('--weights', type=str, required=True, default='best.pt', help='The weights to be reparameterized')
argparse.add_argument('--custom_yaml', type=str, required=True, default='yolov7-tiny.yaml', help='custom yaml with deploy parameters')
argparse.add_argument('--output', type=str, required=True, default='fku.pt', help='The target path to save reparameterized weights')
